...
@router.post("/devices/{device_id}/commands", response_model=CommandQueuedResponse)
...
@router.get("/commands/admin/list", response_model=CommandListResponse)
...
@router.post("/commands/{cmd_id}/ack", response_model=OkResponse)
